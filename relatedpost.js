...
function printRelatedLabels(a) {
    ...
    if (titles.length == 0) {
        ...
        while (b < titles.length && b < 20 && b < maxresults) {
            ...
            dw += '<div class="related-post"><div class="related-post-title">' + titles[c] + '</div><a href="' + urls[c] + '" rel="nofollow"><img border="0" class="post-thumbnail" alt="' + titles[c] + '" src="' + thumb[c] + '"/></a></div>';
